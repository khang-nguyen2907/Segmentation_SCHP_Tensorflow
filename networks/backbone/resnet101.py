...
from tensorflow.keras.layers import Input, Dense, Convolution2D, MaxPooling2D, AveragePooling2D, ZeroPadding2D, Dropout, Flatten, Add, Reshape, Activation, Lambda, GlobalAveragePooling2D
...
def identity_block(input_tensor, kernel_size, filters, stage, block):
    ...
    x = Add([x, input_tensor], mode='sum', name='res' + str(stage) + block)
