...
#         # img = tf.convert_to_tensor(pic.transpose((2,0,1)))
...
#     '''
#
#     :param output_flipped:
#     :param matched_parts:
#     :return:
#         output_flipped -- numpy.mdarray(batch_size, num_joints, height, width)
#     '''
#
...
#     # img = np.asarray(img)
#     # trn = BRG2Tensor_transform()(img)
#     # trn = tf.convert_to_tensor(img.transpose((2,0,1)))
#     # trn_rgb = tf.reverse(trn, axis = [0])
#     # print(trn_rgb)